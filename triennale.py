...
ROBOT_A_MAX_CABLE_LENGTH_IN_M = 4.5 # <-- DON'T TOUCH THIS
...
ROBOT_B_MAX_CABLE_LENGTH_IN_M = 3.6 # <-- DON'T TOUCH THIS
...
ROBOT_C_MAX_CABLE_LENGTH_IN_M = 3.9
...
ROBOT_D_MAX_CABLE_LENGTH_IN_M = 4.0 # <-- DON'T TOUCH THIS
