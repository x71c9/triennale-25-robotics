...
ROBOT_A_MAX_CABLE_LENGTH_IN_M = 5.0 # <-- DON'T TOUCH THIS
ROBOT_A_HOMING_CURRENT_LIMITS_IN_UNITS = [280, 280] # <-- EDIT THIS
ROBOT_A_CURRENT_LIMITS_IN_UNITS = [260, 260] # <-- EDIT THIS
ROBOT_A_FILE_PATH = os.path.join(ROBOT_FILES_DIRECTORY, "robotA.txt")

ROBOT_B_MOTOR_IDS = [13,2] # <-- DON'T TOUCH THIS
ROBOT_B_MAX_CABLE_LENGTH_IN_M = 4.1 # <-- DON'T TOUCH THIS
ROBOT_B_HOMING_CURRENT_LIMITS_IN_UNITS = [290, 290] # <-- EDIT THIS
ROBOT_B_CURRENT_LIMITS_IN_UNITS = [260, 260] # <-- EDIT THIS
ROBOT_B_FILE_PATH = os.path.join(ROBOT_FILES_DIRECTORY, "robotB.txt")

ROBOT_C_MOTOR_IDS = [11,1] # <-- DON'T TOUCH THIS
ROBOT_C_MAX_CABLE_LENGTH_IN_M = 4.4
ROBOT_C_HOMING_CURRENT_LIMITS_IN_UNITS = [270, 270] # <-- EDIT THIS
ROBOT_C_CURRENT_LIMITS_IN_UNITS = [260, 260] # <-- EDIT THIS
ROBOT_C_FILE_PATH = os.path.join(ROBOT_FILES_DIRECTORY, "robotC.txt")

ROBOT_D_MOTOR_IDS = [12,0] # <-- DON'T TOUCH THIS
ROBOT_D_MAX_CABLE_LENGTH_IN_M = 5.0 # <-- DON'T TOUCH THIS
ROBOT_D_HOMING_CURRENT_LIMITS_IN_UNITS = [290, 290] # <-- EDIT THIS
ROBOT_D_CURRENT_LIMITS_IN_UNITS = [260, 260] # <-- EDIT THIS
